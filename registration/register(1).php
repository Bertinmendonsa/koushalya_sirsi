...
<hr>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label class="radio-inline"> <input type="radio" name="disabled" value="1">Yes</label>
<label class="radio-inline"><input type="radio" name="disabled" value="0">No</label>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label class="radio-inline"> <input type="radio" name="hostelfacility" value="1">Yes</label>
<label class="radio-inline"><input type="radio" name="hostelfacility" value="0">No</label>
    ...
    <div class="col-md-6">
     ...
     <div class="row">
        ...
        <input type="file" class="form-control photo" name="image" required>
    </div>
        </div>
         <div class="col-md-6">
        <div class="form-group aad">
        <label>Upload Aadhar</label>
        <input type="file" class="form-control aadf" name="aadharfile" required>
    </div>
        </div>
