...
$disabled = $_POST['disabled']; //DISABLED STATUS
...
`bank_branch`, `ifsc_code`, `type_of_disability`, `about_scheme`, `hostel_facility`, `sector`,
`job_role_id`, `center_id`, `photo_path`, `aadhar_path`, `active`, `payment_status`, `payment_transaction_id`,
`enrollment_id`,`scheme_id`,`mother_first_name`,`mother_middle_name`,`mother_last_name`,`password`)
 ...
 '$preStateId','$bankId','$branch','$ifsc','$disabled','$news','$hostelfacility',
 '$sector','$role_Id','$regcenter','photos/$newfilename','aadhar_card/$aadhar_newfilename'
 ,'1','','','$serial','$scheme_Id','$mfname','$mmname','$mlname','$password')";
