...
<!--  <h2>Vertical (basic) form</h2>-->
  <form method="POST" action="master_entry/qualification_add.php">
    <div class="form-group">
      <label for="qualification">Qualification:</label>
      <input type="text" class="form-control qualification" id="qualification" placeholder="Enter Your Qualification" name="qualification">
    </div>
