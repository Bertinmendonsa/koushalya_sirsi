			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						<li class="main_nav_item"><a href="#">Welcome to PMKVY</a></li>
					</ul>
				</div>
			</nav>
		</div>
	...
	<div class="home">
		...
		<div class="hero_slider_container">
			<div class="hero_slider owl-carousel">
				...
				<div class="hero_slide">
					<div class="hero_slide_background" style="background-image:url(images/course_4.jpg)"></div>
					<div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
<!--
						<div class="hero_slide_content text-center">
							<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Get your <span>Education</span> today!</h1>
...
-->
			...
			<div class="hero_slider_left hero_slider_nav trans_200"><span class="trans_200"><i style="font-size: 32px;" class="fa fa-angle-left"></i></span></div>
